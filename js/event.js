// modal
var resultToggle = new bootstrap.Modal(document.querySelector('#resultModal'));

var flowerAniamtion = function flowerAniamtion(target, position) {
  gsap.set(target, {
...
var scratchHandAniamtion = function scratchHandAniamtion() {
  var hand = ".js-scratch-hand";
  var tl = gsap.timeline();
  gsap.set(hand, {
    opacity: 0
  });
